...
| [OpenServoCore](https://github.com/OpenServoCore/open-servo-core) ![GitHub Repo stars](https://img.shields.io/github/stars/OpenServoCore/open-servo-core?style=social) |  The goal of this project is to create an open servo controller board and firmware. | ![GitHub last commit](https://img.shields.io/github/last-commit/OpenServoCore/open-servo-core?style=for-the-badge) |
